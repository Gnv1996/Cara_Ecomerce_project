...
const CartPageFooter = () => {
    return (
        <div className=' relative top-72 cpf'>
            <footer className="footer p-10 fof text-xl fotBg text-base-content">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t fotBg text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='font-bold'>BUILT BY GAUTAM. <br /></p>
                </div>
